...
opzioni di impacchettamento \n 'expand', 'fill' e 'anchor'.\ncfr http://linuxdidattica.org/docs/altre_scuole/msm_p/txs_01.html"
...
radice = Tk()  ### (2)
radice.title("http://linuxdidattica.org/docs/altre_scuole/msm_p/txs_01.html")
mioContenitore1 = Frame(radice)  ### (1b)
mioContenitore1.pack()  ### (2b)
